        ...
        >
            ...
            <div class="p-6 sm:p-7">
                ...
                <div class="space-y-3">
                    ...
                    <a href="{{ route('social.redirect', 'facebook') }}" class="flex w-full items-center justify-center gap-3 rounded-2xl border-2 border-gray-200 bg-[#1877F2] text-white px-4 py-3 font-bold text-dark transition-all hover:bg-[#1669d9]">
