            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6" x-data="{ submitting: false }" @submit="submitting = true">
                ...
                <div class="relative">
                    <input id="email" name="email" type="email" value="{{ old('email') }}" required autofocus placeholder=" "
                        class="peer h-12 w-full rounded-2xl border border-gray-300 bg-white px-4 text-sm font-medium text-gray-900 outline-none transition focus:border-emerald-400 focus:ring-2 focus:ring-emerald-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 dark:focus:border-emerald-500/50 dark:focus:bg-gray-900">
                    <label for="email" class="rounded-full pointer-events-none absolute left-3 top-0 z-10 -translate-y-1/2 bg-white px-1.5 text-xs font-semibold text-gray-500 transition-all peer-placeholder-shown:left-4 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:bg-transparent peer-placeholder-shown:px-0 peer-placeholder-shown:text-sm peer-placeholder-shown:font-medium peer-focus:left-3 peer-focus:top-0 peer-focus:-translate-y-1/2 peer-focus:bg-white peer-focus:px-1.5 peer-focus:text-xs peer-focus:font-semibold peer-focus:text-emerald-600 dark:bg-gray-950 dark:text-gray-400 dark:peer-placeholder-shown:bg-transparent dark:peer-focus:bg-gray-950 dark:peer-focus:text-emerald-400">
                        Email
                    </label>
                </div>
                ...
                <div x-data="{ showPassword: false }">
                    <div class="relative">
                        <input id="password" name="password" :type="showPassword ? 'text' : 'password'" required placeholder=" "
                            class="peer h-12 w-full rounded-2xl border border-gray-300 bg-white px-4 pr-11 text-sm font-medium text-gray-900 outline-none transition focus:border-emerald-400 focus:ring-2 focus:ring-emerald-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 dark:focus:border-emerald-500/50 dark:focus:bg-gray-900">
                        <label for="password" class="rounded-full pointer-events-none absolute left-3 top-0 z-10 -translate-y-1/2 bg-white px-1.5 text-xs font-semibold text-gray-500 transition-all peer-placeholder-shown:left-4 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:bg-transparent peer-placeholder-shown:px-0 peer-placeholder-shown:text-sm peer-placeholder-shown:font-medium peer-focus:left-3 peer-focus:top-0 peer-focus:-translate-y-1/2 peer-focus:bg-white peer-focus:px-1.5 peer-focus:text-xs peer-focus:font-semibold peer-focus:text-emerald-600 dark:bg-gray-950 dark:text-gray-400 dark:peer-placeholder-shown:bg-transparent dark:peer-focus:bg-gray-950 dark:peer-focus:text-emerald-400">
                            Password
                        </label>
                        <button type="button" @click="showPassword = !showPassword" aria-label="Toggle password visibility" class="absolute inset-y-0 right-0 px-3 text-gray-400 transition-colors hover:text-emerald-500 motion-reduce:transition-none dark:text-gray-500">
