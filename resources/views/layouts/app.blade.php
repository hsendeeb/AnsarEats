...
<head>
    ...
    <style>
        ...
        #pwa-splash.splash-active {
            animation: splashHide 4.2s ease-in-out forwards;
        }

        #pwa-splash.splash-active #splash-logo-wrap {
            animation: splashLogoAnim 4s ease-out forwards;
        }

        #pwa-splash.splash-active #splash-name-el {
...
<body
    ...
    <script>
        (function() {
            ...
            // Force a reflow so the browser registers the visibility change
            void splash.offsetWidth;

            // Now trigger the CSS animations from the start
                ...
                <div class="flex items-center">
                    ...
                    @auth
                        ...
                        <div class="relative flex md:hidden items-center">
                            <button type="button" @click="$dispatch('toggle-location-drawer')"
                        ...
                        <div class="relative flex md:hidden items-center">
                            <button type="button" @click="$dispatch('toggle-location-drawer')"
                                ...
                                <div class="flex flex-col justify-center">
                                    ...
                                    <div class="flex items-center gap-1">
                                        <span
                                            class="text-sm font-black text-gray-900 dark:text-white leading-none max-w-[120px] truncate">Select Location</span>
                                        <svg class="w-3.5 h-3.5 text-gray-400 transition-transform duration-200"
    ...
    @endunless
    @include('layouts.partials.delivery-location-drawer')
