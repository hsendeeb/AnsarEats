        ...
        <div x-show="open" 
            ...
            <template x-if="Object.keys(cart.items || {}).length > 0">
                <div class="flex-shrink-0 border-t border-gray-100 p-6 bg-white">
                    ...
                    <a href="{{ route('checkout') }}" @click="open = false" class="block w-full text-center py-4 bg-emerald-500 hover:bg-emerald-400 text-white font-bold rounded-2xl shadow-lg shadow-emerald-500/20 hover:shadow-xl transition-all transform hover:-translate-y-0.5 active:scale-[0.98] text-lg">
                        Checkout →
                    </a>
                </div>
            </template>
