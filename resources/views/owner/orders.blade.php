                                            ...
                                            <div class="flex-1">
                                                ...
                                                <div class="flex flex-wrap gap-x-6 gap-y-2">
                                                    ...
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        @php
                                                            $hasCoords = $order->user->delivery_latitude && $order->user->delivery_longitude;
                                                        @endphp
                                                        <a href="{{ $hasCoords ? 'https://www.google.com/maps?q=' . $order->user->delivery_latitude . ',' . $order->user->delivery_longitude : 'https://www.google.com/maps?q=' . urlencode($order->delivery_address) }}" target="_blank" rel="noopener"
                                    ...
                                    <div class="mt-5 pt-5 border-t border-gray-50 bg-gray-50/30 -mx-5 -mb-5 px-5 pb-5">
                                        <div class="flex flex-wrap gap-2">
                                            @foreach($order->orderItems as $item)
                                                @php
                                                    $displayVariantLabel = $item->displayVariantLabel();
                                                @endphp
