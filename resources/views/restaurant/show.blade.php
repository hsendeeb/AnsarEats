                        ...
                        <div id="category-{{ $category->id }}" class="mb-16 scroll-mt-36 lg:scroll-mt-28">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                @foreach($category->menuItems as $item)
                                    <div id="item-card-{{ $item->id }}" class="relative bg-white dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800 rounded-2xl p-4 flex gap-4 hover:shadow-xl transition-shadow group {{ !$item->is_available ? 'opacity-60 grayscale' : '' }}"
